...
KAFKA_CONFIG = {
    ...
    "socket.keepalive.enable": True,  # включаем поддержку keep-alive для сокета, типа для стабильности
...
def delivery_report(err, msg):
    ...
    if err is not None:
        ...
        logger.info(
            f"Сообщение отправлено: topic={msg.topic()},"
...
def main():
    ...
    try:
        ...
        for i in range(MAX_MESSAGES):
            ...
            producer.poll(0)  # неблокирующий poll - признак асинхронности
        producer.flush(timeout=10)  # Освобождаем ресурсы
