...
- [3.5 Django Lab](#35-django-lab)
  ...
  - [Pandas использование](#pandas-использование)
    - [использование датафрейм index.py](#использование-датафрейм-indexpy)
    - [Фильтрация данных](#фильтрация-данных)
    - [Integrace PyCharm с jupyter notebooks](#integrace-pycharm-с-jupyter-notebooks)
    - [продолжение использование датафрейм - индексы](#продолжение-использование-датафрейм---индексы)
    - [DataFrame -  Фильтрация](#dataframe----фильтрация)
    - [DataFrame - группировка](#dataframe---группировка)
    - [Работа с внешними данными](#работа-с-внешними-данными)
    - [визуализация данных 2:21:08](#визуализация-данных-22108)
    - [Базовые операции с DataFrame](#базовые-операции-с-dataframe)
...
Например, любой словарь можно конвертировать в датафрейм.

см презентацию

см m3_5_lab/demo_pandas/index.py

### использование датафрейм index.py

### Фильтрация данных

2:04:25

### Integrace PyCharm с jupyter notebooks

2:05:11

### продолжение использование датафрейм - индексы
...
### визуализация данных 2:21:08

см. [построения графиков в Visual Studio Code ](demo_pandas/doc/matplotlib-visualisation.md)

### Базовые операции с DataFrame

2:24:59

- получим количество элементов в каждом столбце
- макс. значение в столбце water_need
- среднее значение в столбце water_need
