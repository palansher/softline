...
если уже залогинился то на других пунктах запрашивать креды уже не нужно


все функции сделать в отдельном модуле (файле)

3 файла:

- обекты admins и items
- actions (функции)

импортировать их в магазин
