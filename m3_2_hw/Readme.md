...
- [Выполнение ДЗ 3.2](#выполнение-дз-32)
  ...
  - [См. Скрины](#см-скрины)
  - [DB](#db)
    - [Создать структуру для пустого магазина](#создать-структуру-для-пустого-магазина)
    - [Backup](#backup)
  - [Маршруты](#маршруты)
  - [Меню](#меню)
  - [Корзина](#корзина)
...
## См. [Скрины](hw-result/screenshots.md)

## DB

### Создать структуру для пустого магазина

`.infra/db/create-db-structure.sql`

### Backup

можно восстановить с дополнительными данными (корзина,  заказы ..) [отсюда](.infra/db/backup)
