# Задание 3.9 - Запись и чтение объектов в/из Kafka (kafka-python)

- [Задание 3.9 - Запись и чтение объектов в/из Kafka (kafka-python)](#задание-39---запись-и-чтение-объектов-виз-kafka-kafka-python)
...
Использована устаревшая библиотека `kafka` на чистом python (kafka-python)
