    ...
    def run(self) -> None:
        ...
        try:
            ...
            for i in range(MAX_MESSAGES):
                ...
                # Мы передаем `key=person.id`, но НЕ передаем жесткий `partition`.
