...
def get_full_info(id):
    ...
    common_response = {
        'id':id,
        'title':data_catalog['title'], # pyright: ignore[reportPossiblyUnboundVariable]
        'price':data_catalog['price'], # pyright: ignore[reportPossiblyUnboundVariable]
        'quantity':data_warehouse['quantity'], # pyright: ignore[reportPossiblyUnboundVariable]
        "status":data_warehouse['status'] # pyright: ignore[reportPossiblyUnboundVariable]
    }
