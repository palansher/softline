...
class MyTestIntegrationForCrudTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        """Данный метод будет запущен первым, чтобы подготовить окружение для тестирования."""
    ...
    def test_select_table(self):
        self.cur.execute(
            "INSERT INTO students(name,phone) VALUES(%s,%s)", ("Алексей", "+79234234231")
        )
        self.conn.commit()
    ...
    def test_update_table(self):
        self.cur.execute(
            "INSERT INTO students(name,phone) VALUES(%s,%s)", ("Игорь", "+79334234231")
        )
        self.conn.commit()
        # Обновление данных
    ...
    def test_delete_table(self):
        self.cur.execute(
            "INSERT INTO students(name,phone) VALUES(%s,%s)", ("Мария", "+79934234231")
        )
        self.conn.commit()
